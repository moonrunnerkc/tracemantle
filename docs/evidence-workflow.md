...
The escaped-backtick, list-continuation and numeric-overflow corrections are source fixes under `[Unreleased]`, after published 1.6.0. [Current regression evidence](verification/audit-1.6.1/acceptance.md#dependency-and-numeric-boundary-corrections) uses synthetic approved records in temporary trusted Git repositories and mutations of the attributable Promptfoo export. No skill or evaluator was executed.
